...
class AccNormSpectrogramEmbedding_DataSubSet(Embedding_DataSubSet): 
    def __init__(self, dss: Canonical_DataSubSet, nperseg = 50, noverlap = 30):
        ...
        self.embedding_name = "AccNormSpectrogramEmbedding-{}-{}".format(nperseg,noverlap)
...
class AccNormSpectrogramEmbedding_DataSet(Embedding_DataSet): 
    ...
    def import_from_canonical(self, ds: Canonical_DataSet):
        self.train      = AccNormSpectrogramEmbedding_DataSubSet(ds.train, nperseg=self.nperseg, 
                                                                noverlap=self.noverlap)
        self.validation = AccNormSpectrogramEmbedding_DataSubSet(ds.validation, nperseg=self.nperseg, 
                                                                noverlap=self.noverlap)
        self.test       = AccNormSpectrogramEmbedding_DataSubSet(ds.test, nperseg=self.nperseg, 
                                                                noverlap=self.noverlap)
