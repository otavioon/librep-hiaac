...
class CustomMultiEvaluator:
    ...
    def evalutate(self, model: Estimator, Xs: List[ArrayLike],
                  y: List[ArrayLike]) -> dict:
        raise NotImplementedError


Evaluators = Union[SupervisedEvaluator, UnsupervisedEvaluator,
                   CustomSimpleEvaluator, CustomMultiEvaluator]
